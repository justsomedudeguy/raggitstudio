...
- [ ] **Item 3**: Split `App.tsx` (1478+ lines) into per-view files: `ChatView.tsx`, `CorpusView.tsx`, `ArchivesView.tsx`, `RetrievalLab.tsx`, `StatusView.tsx`, `AvailableDataPanel.tsx`.
...
- [ ] **Item 6**: Add comments to `.env.example` explaining model ID configurability.
